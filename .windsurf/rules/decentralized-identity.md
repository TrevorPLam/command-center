...
globs:
  ['**/identity/**/*.ts', '**/did/**/*.ts', '**/verifiable-credentials/**/*.ts', '**/ssi/**/*.ts']
---
...
export class DecentralizedIdentityManager {
  ...
  async createDID(
    ...
    const keyPairs = await this.keyManager.generateKeyPairs(
      options.keyTypes || ['Ed25519', 'secp256k1']
    )
  ...
  private async createCredential(request: CredentialIssuanceRequest): Promise<Credential> {
    return {
      '@context': ['https://www.w3.org/2018/credentials/v1', ...(request.context || [])],
  ...
  private async verifyCredentialStatus(
    credential: VerifiableCredential
  ...
  private async validateCredentialSchema(
    credential: VerifiableCredential | CredentialIssuanceRequest
...
export class CredentialVerifier {
  ...
  private async verifyIssuer(
    issuer: string
  ): Promise<{ valid: boolean; issuerDID?: string; reason?: string }> {
    try {
